...
console.log(
  "camRollFunction.validatePhotoPost({id: 5,  descriprion: 98,createdAt: new Date(2017, 4, 3),author: 'Гавриленко Егор',  photoLink: 'photo/dog-and-cat-1024x768.jpg',  tag:  ['goodtime','dog','good_boy','gm'],like:  []})"
);
console.log(
  camRollFunction.validatePhotoPost({
    id: 5,
    descriprion: 98,
...
console.log(
  "camRollFunction.validatePhotoPost({id: '5',  descriprion: '98',createdAt: new Date(2017, 4, 3),author: 'Гавриленко Егор',  photoLink: 'photo/dog-and-cat-1024x768.jpg',  tag:  'goodtime',like:  []})"
);
console.log(
  camRollFunction.validatePhotoPost({
    id: '5',
...
//editPhotoPost//
console.log(
  "camRollFunction.editPhotoPost(322, {descriprion: '98',  photoLink: 'photo/dog-and-cat-1024x768.jpg'})"
);
console.log(
  camRollFunction.editPhotoPost(322, {
    descriprion: '98',
    photoLink: 'photo/dog-and-cat-1024x768.jpg',
  })
);
...
console.log(
  "camRollFunction.editPhotoPost(2, descriprion: '98',  photoLink: 'photo/dog-and-cat-1024x768.jpg'})"
);
console.log(
  camRollFunction.editPhotoPost(2, {
    descriprion: '98',
    photoLink: 'photo/dog-and-cat-1024x768.jpg',
  })
);
...
//addPhotoPost//
console.log(
  "camRollFunction.addPhotoPost({descriprion: 'поле',author: 'Вася Пупкин', photoLink: 'photo/purple-lavender-field-provence-france.jpg',tag: ['goodtime','gm','purple','nature']})"
);
console.log(
  camRollFunction.addPhotoPost({
    descriprion: 'поле',
    author: 'Вася Пупкин',
...
console.log(
  "camRollFunction.addPhotoPost({descriprion: 'поле',author: 'Вася Пупкин',tag: ['goodtime','gm','purple','nature']})"
);
console.log(
  camRollFunction.addPhotoPost({
    descriprion: 'поле',
