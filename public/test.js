...
console.log(camRollFunction.validatePhotoPost({
  id: 5,
  descriprion: 98,
...
console.log(camRollFunction.addPhotoPost({
  descriprion: "поле",
  author: "Вася Пупкин",
