...
var workWithDOM = function() {
    ...
    function loadMorePhoto() {
        ...
        events.getPosts(last, count, filterConfig).then((result) => {
            creatingPost(JSON.parse(result,function(key, value) {
    ...
    function filterSelected() {
        ...
        events.getPosts(0, 10, filterConfig).then((result) => {
            creatingPost(JSON.parse(result,function(key, value) {
                if (key == 'createdAt') return new Date(value);
                return value;}));
            },
