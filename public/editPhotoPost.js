...
var editPhotoPostDOM = function() {
    function edit() {
        ...
        events.getPost(postid).then((result) => {
            
            editPhotoPost(JSON.parse(result,function(key, value) {
    ...
    function editPhotoPost(post) {
        ...
        button_ok.onclick = function() {
            ...
            change['id']=post.id
            events.editPost(change).catch((err) =>
        ...
        events.getPosts(0, 10, workWithDOM.filterConfig).then((result) => {
